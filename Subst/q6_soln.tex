...
\begin{explanation}
	...
	$\int_{-\frac{\pi}{2}}^{\frac{\pi}{2}} \cos(x)\sqrt{1-\cos^2(x)}\d x=\int_{-\frac{\pi}{2}}^{0} \cos(x)\sqrt{1-\cos^2(x)}\d x+\int_{0}^{\frac{\pi}{2}} \cos(x)\sqrt{1-\cos^2(x)}\d x$
	...
	$\int_{-\frac{\pi}{2}}^{\frac{\pi}{2}} \cos(x)\sqrt{1-\cos^2(x)}\d x=2\int_{0}^{\frac{\pi}{2}} \cos(x)\sqrt{1-\cos^2(x)}\d x$.
