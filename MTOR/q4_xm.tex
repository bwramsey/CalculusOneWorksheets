...
\item\label{partB} \textbf{Find the value} of $\displaystyle \eval{\dfrac{dx}{dt}}_{x=2 m}$.

\item\label{partC} \textbf{Find a formula} for the perimeter, $P$, of the rectangle as a function of $x$. (This is denoted as $P(x)$.)\\[1em]
\item\label{partD} \textbf{Find the value} of $\displaystyle \eval{\dfrac{dP}{dt}}_{x=2 m}$.
