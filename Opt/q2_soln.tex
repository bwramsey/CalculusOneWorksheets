...
\begin{problem}
  ...
  \begin{image}
    \includegraphics{figure1_pdf.png}
  \end{image}
  ...
  \begin{enumerate}
    \item  Label the picture with variables.
      \begin{explanation}
        \begin{image}
          \includegraphics{figure6_pdf.png}
	\end{image}
      \end{explanation}
...
\begin{explanation}
    ...
    \item  Reduce your optimization equation to one variable using the constraint equation.
      ...
      \begin{explanation}
        $$ x = \dfrac{30}{y} \quad (\text{Note that } y \neq 0) $$
        \begin{align}
          A &= \left( \dfrac{30}{y} + 4 \right)(y+2) \\
            &= 30 + 4y + \dfrac{60}{y} + 8 \\
            &=4y + \dfrac{60}{y} + 38 \label{eqn3}
        \end{align}
      \end{explanation}
    ...
    \item  Use the appropriate method to find and justify your global extremum.
      \begin{explanation}
        ...
        $$ \dfrac{d^2A}{dy^2} = \dfrac{120}{y^3} $$
        $$ \eval{\dfrac{d^2A}{dy^2}}_{y=\sqrt{15}} = \dfrac{120}{15 \sqrt{15}} > 0. $$
    ...
    \item  Be sure to answer the question asked in the original problem.
      \begin{explanation}
        ...
        $$ x = \dfrac{30}{y} = \dfrac{30}{\sqrt{15}} = \dfrac{30 \sqrt{15}}{15} = 2 \sqrt{15} \, m $$
      \end{explanation}
    \end{enumerate}
\end{problem}
