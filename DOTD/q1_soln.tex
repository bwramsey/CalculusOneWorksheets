...
\begin{problem}
 ...
 \begin{enumerate}
    \item
      In Figure 1 on the top, what are the coordinates of $P$ and $Q$?  In Figure 2 on the bottom, what are the expressions for the coordinates of $P$ and $Q$?

	\begin{explanation}
	Figure 1 on the top: $P(a,f(a))$ and $Q(x,f(x))$ \\
	Figure 2 on the bottom: $P(a,f(a))$ and $Q((a+h),f(a+h))$
