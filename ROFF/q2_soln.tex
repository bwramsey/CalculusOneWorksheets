...
%				\begin{image}
%					\includegraphics{signchart1.png}
%				\end{image}
...
\[
\begin{array}{c|cccc}
\text{row} & (-\infty,-1) & (-1,0) & \left(0,\frac{5}{2}\right) & \left(\frac{5}{2},\infty\right)\\\hline
x^3 & - & - & + & +\\
(2x-5)^2 & + & + & + & +\\
x+1 & - & + & + & +\\
f(x) & + & - & + & +\\
...
\[
\begin{array}{c|cccc}
 & (-\infty,-\sqrt{5}) & \left(-\sqrt{5},\,1\right) & \left(1,\,\sqrt{5}\right) & \left(\sqrt{5},\,\infty\right)\\\hline
5^{x}        & + & + & + & +\\
2-2^{x}      & + & + & - & -\\
x+\sqrt{5}   & - &  + & + & +\\
x-\sqrt{5}   & - & - & - &  +\\
