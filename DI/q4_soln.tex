...
\begin{enumerate}
	...
	\item $\displaystyle \int_1^3 (2x-4) \d x$

		\begin{explanation}
		\begin{image}
		\includegraphics[]{diimage007.png}
		...
		Therefore, $\displaystyle \int_1^3 (2x-4) \d x=0$ \\ \\
...
\item $\displaystyle \int_1^3 |2x-4| \d x$
		...
		The functions changes the sign at $x=2$. Therefore, we will split the integral into two integrals:
		 ...
		 $\displaystyle \int_1^3 |2x-4| \d x=\displaystyle \int_1^2 |2x-4| \d x+\displaystyle \int_2^3 |2x-4| \d x$.
		 
		 Since the function is negative for $x<2$ and positive for $x>2$, we write
		 
		$\displaystyle \int_1^3 |2x-4| \d x=-\displaystyle \int_1^2 (2x-4) \d x+\displaystyle \int_2^3 (2x-4) \d x=1+1=2$. \\ \\
		
		\end{explanation}

\item  $\displaystyle \int_0^1 (2x-4) \d x$

		\begin{explanation}
		\begin{image}
		\includegraphics[]{diimage008.png}
		\end{image}
		...
		Therefore,$\displaystyle \int_0^1 (2x-4) \d x=-3$ \\ \\
		
		
		\end{explanation}

\item  $\displaystyle \int_{-1}^3 \sqrt{4-(x-1)^2} \d x$
		\begin{explanation}
		
		\begin{image}
		\includegraphics[]{diimage006.png}
		\end{image}
		...
		$\displaystyle \int_{-1}^3 \sqrt{4-(x-1)^2} \d x= 2\pi$
