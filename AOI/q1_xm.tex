...
Solve the following word problems:
	...
	\item  The velocity function for an object moving along a line east/west is given by
		...
		\begin{enumerate}
			...
			\item Find the total displacement the object traveled 
				from $2$ minutes to $6$ minutes (assume east is positive).\\ \\

			\item Find the total distance the object traveled from $2$ minutes to 
				$6$ minutes.\\ \\
			
			\item  Suppose that the object's position $2$ minutes into the trip is 
				$5$ feet of a placement marker.  What is its position (relative to the placement marker) at $6$ minutes.\\ \\
			\end{enumerate}
