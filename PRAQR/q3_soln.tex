...
\begin{explanation}
	...
	\item $\left[ \dfrac{d}{dx} \left( \frac{f}{g} \right) \right]_{x=5}$
\begin{explanation}
		\begin{align*}
		\left[ \dfrac{d}{dx} \left( \frac{f}{g} \right) \right] (5) &= \frac{(g(5) \cdot \left[ \dfrac{d}{dx} f \right] (5)) - (f(5) \cdot \left[ \dfrac{d}{dx} g \right](5))}{(g(5))^2}  \\
		&= \frac{(3)(8) - (7)(-4)}{3^2}  \\
...
\begin{explanation}
	...
	\item  $\eval{ \dfrac{d}{dx} \left( \frac{g(x)}{x+2} \right)}_{x=5}$
\begin{explanation}
		\begin{align*}
		\eval{\dfrac{d}{dx} \left( \frac{g(x)}{x+2} \right)}_{x=5} &= \eval{\frac{(x+2) \cdot g'(x)) - (g(x) \cdot (x+2)'}{(x+2)^2}}_{x=5}  \\
	...
	\item $\eval{ \dfrac{d}{dx} \left( \frac{xf(x)}{g(x)} \right)}_{x=5}$
\begin{explanation}
		\begin{align*}
		\eval{\dfrac{d}{dx} \left( \frac{xf(x)}{g(x)} \right)}_{x=5} &= \eval{\frac{(((xf(x))' \cdot g(x)) - (g'(x) \cdot (xf(x)))}{(g(x))^2}}_{x=5}  \\
...
\begin{explanation}
		...
		\begin{align*}
			\lim_{x\to 5} \dfrac{\frac{x+2}{f(x)} - 1 }{x-5} &= k'(5) \\
				&= \eval{\dfrac{d}{dx} \left( \frac{x+2}{f(x)} \right)}_{x=5}\\
