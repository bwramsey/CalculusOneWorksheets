...
\begin{explanation} 
		...
		$$ 2x \dfrac{dx}{dt} + 2y \dfrac{dy}{dt} = 2z \dfrac{dz}{dt}$$
		
		Canceling the 2's and plugging in the known quantities yields:
		$$ z\dfrac{dz}{dt} = (15)(30) + (10)(15) = 450 + 150 = 600 $$
		
		In the above work, the student did correctly compute that $z^2 = 325$ at this fixed instant in time.  So $z = 5\sqrt{13}$, and we can solve for $\dfrac{dz}{dt}$ to obtain
		$$ \Bigl[\dfrac{dz}{dt}\Bigr]_{x=15,y=10} = \frac{600}{5 \sqrt{13}} = \frac{120}{\sqrt{13}} \, mph $$
	\end{explanation}	
